...
const STR = {
  ...
  src_dir_auto: { ja: '向き：自動', en: 'Direction: auto', fr: 'Sens : auto' },
  src_dir_h: { ja: '横書き', en: 'Horizontal writing', fr: 'Écriture horizontale' },
  src_dir_v: { ja: '縦書き', en: 'Vertical writing', fr: 'Écriture verticale' },
