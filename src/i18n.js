...
const STR = {
  ...
  src_lbl_file: { ja: 'ファイルを選ぶ（PDF、または教科書のページなどの画像）', en: 'Choose a file (a PDF, or an image such as a textbook page)', fr: 'Choisir un fichier (PDF, ou image telle qu’une page de manuel)' },
