...
const STR = {
  ...
  src_browse: { ja: 'ファイルを選ぶ', en: 'Choose files', fr: 'Choisir des fichiers' },
  src_lbl_file: { ja: 'ここにドロップしてもかまいません（PDF・Word・テキスト、または教科書のページなどの画像。複数まとめて可）', en: 'Or drop them here (PDF, Word, plain text, or images such as textbook pages; several at once)', fr: 'Ou déposez-les ici (PDF, Word, texte brut, ou images telles que des pages de manuel ; plusieurs à la fois)' },
  src_remove: { ja: 'このファイルを外す', en: 'Remove this file', fr: 'Retirer ce fichier' },
  src_checking: { ja: '向きを調べています… {n}/{total}', en: 'Working out which way the page reads… {n}/{total}', fr: 'Recherche du sens de lecture… {n}/{total}' },
  src_ask: { ja: 'どの向きなら文字が読めますか。', en: 'Which way up does the page read?', fr: 'Dans quel sens la page se lit-elle ?' },
  src_yoko: { ja: '横書き', en: 'Horizontal', fr: 'Horizontal' },
  src_tate: { ja: '縦書き', en: 'Vertical', fr: 'Vertical' },
  ...
  src_pdf_page: { ja: 'PDF を読み込み中… {n}/{total} ページ', en: 'Reading the PDF… page {n} of {total}', fr: 'Lecture du PDF… page {n} sur {total}' },
  ...
  blankpos_inline: { ja: '文中（読みは右に）', en: 'In the sentence (reading at right)', fr: 'Dans la phrase (lecture à droite)' },
  blankpos_column: { ja: '横の欄', en: 'Side column', fr: 'Colonne latérale' },
  ...
  lbl_sheet_kind: { ja: 'テストの種類：', en: 'Kind of test:', fr: 'Type de test :' },
  kind_sentences: { ja: '文のテスト', en: 'Sentence worksheet', fr: 'Test sur phrases' },
  kind_choice: { ja: '選択問題', en: 'Multiple choice', fr: 'QCM' },
  kind_hint_sentences: { ja: '文を選んで、漢字を書かせたり読ませたりします。', en: 'Pick sentences; the pupil writes or reads the kanji.', fr: 'Choisissez des phrases ; l\u2019\u00e9l\u00e8ve \u00e9crit ou lit les kanji.' },
  kind_hint_choice: { ja: '語を選んで、いくつかの中から正しい書き方を選ばせます。', en: 'Pick words; the pupil picks the correct spelling out of several.', fr: 'Choisissez des mots ; l\u2019\u00e9l\u00e8ve choisit la bonne graphie.' },
  sec_add_words: { ja: '語を追加', en: 'Add words', fr: 'Ajouter des mots' },
  sec_edit_questions: { ja: '問題を編集', en: 'Edit questions', fr: 'Modifier les questions' },
  lbl_pick_words: { ja: '語をえらぶ', en: 'Choose words', fr: 'Choisir les mots' },
  chk_easy_words: { ja: 'やさしい語だけ（学年以下の漢字）', en: 'Easy words only (kanji at or below the level)', fr: 'Mots faciles seulement' },
  btn_find_words: { ja: '選んだ漢字で語をさがす', en: 'Find words for the chosen kanji', fr: 'Chercher des mots pour ces kanji' },
  btn_extract_words: { ja: '語を取り出す', en: 'Take the words out', fr: 'Extraire les mots' },
  f_per_page_q: { ja: '1ページの問題数', en: 'Questions per page', fr: 'Questions par page' },
  f_choice_count: { ja: '選択肢の数', en: 'Choices per question', fr: 'Nombre de choix' },
  footer_strokes: { ja: '字形', en: 'Character shapes', fr: 'Formes des caract\u00e8res' },
  f_choice_dir: { ja: '問題の向き', en: 'Direction', fr: 'Sens' },
  dir_kanji: { ja: 'よみ → 漢字をえらぶ', en: 'Reading, pick the kanji', fr: 'Lecture, choisir les kanji' },
  dir_reading: { ja: '漢字 → よみをえらぶ', en: 'Kanji, pick the reading', fr: 'Kanji, choisir la lecture' },
  f_choice_style: { ja: 'まちがいの作り方', en: 'How wrong answers are made', fr: 'Fabrication des mauvaises r\u00e9ponses' },
  choice_style_real: { ja: '実在する漢字だけ', en: 'Real kanji only', fr: 'Kanji existants seulement' },
  choice_style_made: { ja: '作った漢字も使う（むずかしい）', en: 'Also invented kanji (harder)', fr: 'Aussi des kanji invent\u00e9s (plus difficile)' },
  btn_shuffle_answers: { ja: '正解の位置をシャッフル', en: 'Shuffle where the answers sit', fr: 'M\u00e9langer la place des r\u00e9ponses' },
  ...
  btn_regenerate: { ja: 'この問題を作り直す', en: 'Make this question again', fr: 'Refaire cette question' },
  count_words: { ja: '{n}語', en: '{n} words', fr: '{n} mots' },
  no_words: { ja: 'この漢字の語は見つかりません', en: 'no words found for this kanji', fr: 'aucun mot trouv\u00e9 pour ce kanji' },
  lbl_from_text: { ja: '文', en: 'text', fr: 'texte' },
  alert_no_words: { ja: '漢字の語が見つかりませんでした。', en: 'No kanji words were found.', fr: 'Aucun mot en kanji trouv\u00e9.' },
  alert_no_strokes: { ja: '字を作るためのデータを取得できませんでした（オフラインかもしれません）。', en: 'The data needed to invent characters could not be fetched (you may be offline).', fr: 'Les donn\u00e9es n\u00e9cessaires pour inventer des caract\u00e8res n\u2019ont pas pu \u00eatre r\u00e9cup\u00e9r\u00e9es (peut-\u00eatre hors ligne).' },
